...
public class CrossFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain chain) throws IOException, ServletException {
        ...
        httpResponse.addHeader("Access-Control-Allow-Headers",
                "Accept,token,Origin, No-Cache, X-Requested-With, If-Modified-Since, Pragma, Last-Modified, Cache-Control, Expires, Content-Type, X-E4M-With,Authorization");// 允许所有的请求header访问，可以自定义设置任意请求头信息 后期加上 authorization
        ...
        httpResponse.setHeader("Access-Control-Expose-Headers", "new-token");
        //httpResponse.setHeader("Access-Control-Expose-Headers", "Authorization");
        //检查浏览器的request是否符合过滤条件
